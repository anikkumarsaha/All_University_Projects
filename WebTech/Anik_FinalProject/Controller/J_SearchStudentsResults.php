		...
		<table width="100%">
	      ...
	      <td>
	        <table border="1" width="100%"  class="w3-table w3-striped w3-border">
	          ...
	          <tr height="50px">
	            <td width="90%">
	              <a href="../Views/J_OtherProfiles.php?id=<?=$data['Id']?>"><?=$data['Username']?></a>
	            </td>
	            <td>
								<button type="button" name="Invite" id="Invite" onclick="Invt(this.value)"value="<?=$data['Id']?>">Invite</button>
	            </td>
	          </tr>
						<?php } ?>
					</table>

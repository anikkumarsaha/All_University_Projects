...
<?php
  ...
  if(isset($_POST['Submit']))
  {
    ...
    {
      $result = J_SearchApplicantsByName($_POST['Search']);
    }
    else {
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="J_CSS_For_SearchApplicantsResults.css">
		...
		<table width="100%">
	      ...
	      <td>
	        <table border="1" width="100%"  class="w3-table w3-striped w3-border">
	          ...
	          <tr height="50px">
	            <td width="90%">
	              <a href="../Views/J_ApplicantProfiles.php?id=<?=$data['id']?>"><?=$data['Username']?></a>
	            </td>
	            <td>
